          ...
          <div className="lg:w-[65%]">
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
                {listExpenses.length} {listExpenses.length === 1 ? "item" : "items"}
              </div>
            </div>
            ...
            {listExpenses.length > 0 ? (
                      ...
                      <div className="flex flex-row sm:items-start sm:justify-between gap-4">
                        <div className="flex items-start space-x-3 sm:space-x-4 flex-1 min-w-0">
                          <div className="relative flex-shrink-0">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-xl sm:rounded-2xl flex items-center justify-center text-white text-lg sm:text-xl group-hover:shadow-lg transition-all duration-300 hover:scale-105">
                              {category?.icon || "💰"}
                            </div>
                          </div>
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">No expense yet</h3>
                <p className="text-gray-600 mb-6">Start by adding your first expense source</p>
