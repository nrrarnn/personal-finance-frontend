    ...
    <>
      <div className="bg-white w-full h-full py-24 px-6 md:px-32 flex flex-wrap">
        <div className="w-full md:w-[50%] flex flex-col justify-center">
          <h1 className="text-5xl font-bold font-poppins pb-3 pt-3"  data-aos="fade-right">Simplify Your Budgeting Process</h1>
          <p className="text-sm font-normal text-slate-700 font-poppins pb-3 md:pr-10"  data-aos="fade-left">SaldaQ helps you track every transaction and keeps your budget aligned with your goals.</p>
